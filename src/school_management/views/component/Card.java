...
public class Card extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        pro = new school_management.utilities.swing.ProgressBarCustom();
        ...
        lbValues.setFont(new java.awt.Font("sansserif", 0, 36)); // NOI18N
        lbValues.setForeground(new java.awt.Color(225, 225, 225));
        lbValues.setText("Giá trị");

        lbIcon.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);

        lbPer.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
    ...
    private school_management.utilities.swing.ProgressBarCustom pro;
