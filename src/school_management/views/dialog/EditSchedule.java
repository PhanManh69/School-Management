...
public final class EditSchedule extends javax.swing.JDialog {

    public String setIdSchedule;

    public EditSchedule(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    }
    ...
    public void editSchedule() {
        btnSave.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String idSchedule = setIdSchedule;
                ...
                if (idSchedule != null && !idSchedule.isEmpty() && classRooms != null && !classRooms.isEmpty()
                        && startDateString != null && !startDateString.isEmpty()
                        && endDateString != null && !endDateString.isEmpty()
                        && content != null && !content.isEmpty()) {
                    ConnectFormLearn.updateSchedule(idSchedule, classRooms, startDateString + " - " + endDateString, content);
                    dispose();
                } else {
                    Message messageDialog = new Message(null, true);
    ...
    public void setScheduleInfo(String idSchedule, String className, String dateApply, String content) {
        setIdSchedule = idSchedule;
        classRoom.setSelectedItem(className);
        txtContent.setText(content);

        String[] dates = dateApply.split(" - ");
        ...
        try {
            startDateValue = dateFormat.parse(startDateStr);
            endDateValue = dateFormat.parse(endDateStr);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditSchedule dialog = new EditSchedule(new javax.swing.JFrame(), true);
