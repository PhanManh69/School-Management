...
public class PopupMenu extends javax.swing.JDialog {
    ...
    public PopupMenu(java.awt.Frame parent, int index, EventMenuSelected eventSelected, String... subMenu) {
        ...
        for (String st : subMenu) {
            ...
            item.setFont(new java.awt.Font("sansserif", Font.PLAIN, 22));
            item.addActionListener((ActionEvent ae) -> {
                eventSelected.menuSelected(index, item.getIndex());
                closeMenu();
            });
            panel.add(item);
            setSize(new Dimension(240, 40 * subMenu.length));
        }
    ...
    private void initComponents() {
        ...
        panel = new school_management.utilities.swing.PanelPopup();
    ...
    private school_management.utilities.swing.PanelPopup panel;
